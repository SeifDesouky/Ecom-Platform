...
namespace EcomPlatform.Infrastructure.Adapters.Shein
{
    /// <summary>
    /// SHEIN Marketplace Adapter.
    /// SHEIN does not provide a public seller/marketplace API.
    /// All methods return NOT_SUPPORTED (501).
    /// Integration is managed manually through the SHEIN Seller Center portal.
    /// </summary>
    public class SheinAdapter : IMarketplaceAdapter
    {
        public MarketplacePlatform Platform => MarketplacePlatform.Shein;
        ...
        private static AdapterResult NotSupported() =>
            AdapterResult.Failure(
                "SHEIN does not provide a public marketplace API. " +
                "Please manage your listings manually via the SHEIN Seller Center.",
                "NOT_SUPPORTED",
                statusCode: 501);
